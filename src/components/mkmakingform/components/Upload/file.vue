<template>
  ...
  >
    ...
    >
      <el-button v-if="ui == 'element'" type="primary" :disabled="disabled" @click="handleAdd">上传</el-button>
      <a-button v-if="ui == 'antd'" icon="upload" :disabled="disabled" @click="handleAdd">上传</a-button>
